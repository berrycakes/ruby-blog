...
ActiveRecord::Schema.define(version: 2022_04_27_155927) do
  ...
  create_table "followed_authors", force: :cascade do |t|
    t.integer "user_id"
    t.integer "author_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "gem_transfers", force: :cascade do |t|
    t.integer "gem"
    t.bigint "author_id", null: false
    t.bigint "article_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["article_id"], name: "index_gem_transfers_on_article_id"
    t.index ["author_id"], name: "index_gem_transfers_on_author_id"
    t.index ["user_id"], name: "index_gem_transfers_on_user_id"
  end
  ...
  add_foreign_key "gem_transfers", "articles"
  add_foreign_key "gem_transfers", "authors"
  add_foreign_key "gem_transfers", "users"
