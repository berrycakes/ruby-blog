...
RSpec.describe "user_payment_methods/new", type: :view do
  before(:each) do
    assign(:user_payment_method, UserPaymentMethod.new(
      user: nil,
      name: "MyString",
      email: "MyString",
      phone: "MyString",
  ...
  it "renders new user_payment_method form" do
    render

    assert_select "form[action=?][method=?]", user_payment_methods_path, "post" do
